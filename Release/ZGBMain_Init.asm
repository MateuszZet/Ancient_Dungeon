...
;ZGBMain_Init.c:3: UINT8 init_bank = 2;
	ld	hl,#_init_bank
	ld	(hl),#0x02
;ZGBMain_Init.c:48: UINT8 next_state = STATE_MENU;
	ld	hl,#_next_state
	ld	(hl),#0x00
;ZGBMain_Init.c:51: SET_N_SPRITE_TYPES(N_SPRITE_TYPES);
...
;--------------------------------------------------------
	.area _CODE_2
;ZGBMain_Init.c:53: void InitStates() {
;	---------------------------------
; Function InitStates
; ---------------------------------
_InitStates::
;ZGBMain_Init.c:54: INIT_STATE(STATE_MENU);
	ld	de,#_stateBanks
	...
	inc	hl
	ld	(hl),#>(_Update_STATE_MENU)
;ZGBMain_Init.c:55: INIT_STATE(STATE_GAME);
	...
	inc	hl
	ld	(hl),#>(_Update_STATE_GAME)
;ZGBMain_Init.c:56: INIT_STATE(STATE_GAME2);
	...
	inc	hl
	ld	(hl),#>(_Update_STATE_GAME2)
;ZGBMain_Init.c:57: INIT_STATE(STATE_GAME3);
	...
	inc	hl
	ld	(hl),#>(_Update_STATE_GAME3)
;ZGBMain_Init.c:58: INIT_STATE(STATE_GAME4);
	...
	inc	hl
	ld	(hl),#>(_Update_STATE_GAME4)
;ZGBMain_Init.c:59: INIT_STATE(STATE_GAME5);
	...
	inc	hl
	ld	(hl),#>(_Update_STATE_GAME5)
;ZGBMain_Init.c:60: INIT_STATE(STATE_GAME6);
	...
	inc	hl
	ld	(hl),#>(_Update_STATE_GAME6)
;ZGBMain_Init.c:61: INIT_STATE(STATE_END);
	...
	ld	(hl),#>(_Update_STATE_END)
	ret
;ZGBMain_Init.c:64: void InitSprites() {
;	---------------------------------
; Function InitSprites
; ---------------------------------
_InitSprites::
;ZGBMain_Init.c:65: INIT_SPRITE(SPRITE_PLAYER, player, 3, FRAME_16x16, 9);
	ld	hl,#0x0000
	push	hl
	ld	hl,#0x0902
	push	hl
	...
	add	sp, #15
;ZGBMain_Init.c:66: INIT_SPRITE(SPRITE_ENEMY, enemy, 3, FRAME_16x16, 5);
	ld	hl,#0x0000
	push	hl
	ld	hl,#0x0502
	push	hl
	...
	call	_InitSpriteInfo
	add	sp, #15
;ZGBMain_Init.c:68: INIT_SPRITE(SPRITE_KEY, key, 3, FRAME_16x16, 6);
	ld	hl,#0x0000
	push	hl
	ld	hl,#0x0602
	push	hl
	...
	call	_InitSpriteInfo
	add	sp, #15
;ZGBMain_Init.c:69: INIT_SPRITE(SPRITE_DOOR, door, 3, FRAME_16x16, 1);
	ld	hl,#0x0000
	push	hl
	ld	hl,#0x0102
	push	hl
	...
	call	_InitSpriteInfo
	add	sp, #15
;ZGBMain_Init.c:70: INIT_SPRITE(SPRITE_DOOROPEN, dooropen, 3, FRAME_16x16, 1);
	ld	hl,#0x0000
	push	hl
	ld	hl,#0x0102
	push	hl
	...
	call	_InitSpriteInfo
	add	sp, #15
;ZGBMain_Init.c:71: INIT_SPRITE(SPRITE_ENEMY2, enemy2, 3, FRAME_16x16, 6);
	ld	hl,#0x0000
	push	hl
	ld	hl,#0x0602
	push	hl
	...
	call	_InitSpriteInfo
	add	sp, #15
;ZGBMain_Init.c:72: INIT_SPRITE(SPRITE_BOMB, bomb, 3, FRAME_16x16, 4);
	ld	hl,#0x0000
	push	hl
	ld	hl,#0x0402
	push	hl
	...
	call	_InitSpriteInfo
	add	sp, #15
;ZGBMain_Init.c:73: INIT_SPRITE(SPRITE_BOMB_L, bomb, 3, FRAME_16x16, 8);
	ld	hl,#0x0000
	push	hl
	ld	hl,#0x0802
	push	hl
	...
	call	_InitSpriteInfo
	add	sp, #15
;ZGBMain_Init.c:74: INIT_SPRITE(SPRITE_ENEMY3, enemy3, 3, FRAME_16x16, 4);
	ld	hl,#0x0000
	push	hl
	ld	hl,#0x0402
	push	hl
	...
	call	_InitSpriteInfo
	add	sp, #15
;ZGBMain_Init.c:75: INIT_SPRITE(SPRITE_DIAMOND, diamond, 3, FRAME_16x16, 5);
	ld	hl,#0x0000
	push	hl
	ld	hl,#0x0502
	push	hl
