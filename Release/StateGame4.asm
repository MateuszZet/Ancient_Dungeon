...
;StateGame4.c:44: SpriteManagerAdd(SPRITE_ENEMY2, 312, 344);
	...
	add	sp, #5
00103$:
;StateGame4.c:63: InitScrollTiles(0, 59, tiles, 3);
	ld	hl,#0x0000
	push	hl
	ld	a,#0x03
	push	af
	...
	add	sp, #7
;StateGame4.c:64: InitScroll(map4Width, map4Height, map4, collilision_tiles4, 0, 3);
	ld	hl,#0x0000
	push	hl
	ld	a,#0x03
	push	af
...
;StateGame4.c:65: SHOW_BKG;
	...
	ld	(hl),c
	ret
;StateGame4.c:70: void Update_STATE_GAME4() {
;	---------------------------------
; Function Update_STATE_GAME4
; ---------------------------------
_Update_STATE_GAME4::
;StateGame4.c:71: if (KEY_PRESSED(J_START)) {
	ld	hl,#_keys
	ld	c,(hl)
	ld	b,#0x00
	bit	7, c
	ret	Z
;StateGame4.c:72: SetState(STATE_GAME5);
	ld	a,#0x05
	push	af
	inc	sp
	call	_SetState
