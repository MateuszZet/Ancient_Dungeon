...
;StateGame5.c:27: SHOW_SPRITES;
	...
	ld	hl,#0xff40
	ld	(hl),c
;StateGame5.c:29: scroll_target = SpriteManagerAdd(SPRITE_PLAYER, 24, 24);
	ld	hl,#0x0018
	push	hl
	ld	l, #0x18
	push	hl
	...
	inc	hl
	ld	(hl),d
;StateGame5.c:31: if( have_diamond == 1){
	ld	hl,#_have_diamond
	ld	a,(hl)
	dec	a
	jr	NZ,00103$
...
;StateGame5.c:32: have_bomb=0;
	...
	jr	00104$
00103$:
;StateGame5.c:35: have_bomb = 1;
	ld	hl,#_have_bomb
	ld	(hl),#0x01
	inc	hl
	ld	(hl),#0x00
00104$:
;StateGame5.c:38: door_x = 186;
	ld	hl,#_door_x
	ld	(hl),#0xba
	inc	hl
	ld	(hl),#0x00
;StateGame5.c:39: door_y = 176;
	ld	hl,#_door_y
	ld	(hl),#0xb0
	inc	hl
	ld	(hl),#0x00
;StateGame5.c:40: SpriteManagerAdd(SPRITE_KEY, 416, 120);
	ld	hl,#0x0078
	push	hl
	ld	hl,#0x01a0
	push	hl
	...
	call	_SpriteManagerAdd
	add	sp, #5
;StateGame5.c:41: SpriteManagerAdd(SPRITE_DOOR, door_x, door_y);
	ld	hl,#_door_y
	ld	a,(hl+)
	ld	h,(hl)
	ld	l,a
	...
	call	_SpriteManagerAdd
	add	sp, #5
;StateGame5.c:43: SpriteManagerAdd(SPRITE_ENEMY, 96, 72);
	ld	hl,#0x0048
	push	hl
	ld	l, #0x60
	push	hl
	...
	call	_SpriteManagerAdd
	add	sp, #5
;StateGame5.c:44: SpriteManagerAdd(SPRITE_ENEMY, 272, 72);
	ld	hl,#0x0048
	push	hl
	ld	hl,#0x0110
	push	hl
	...
	call	_SpriteManagerAdd
	add	sp, #5
;StateGame5.c:45: SpriteManagerAdd(SPRITE_ENEMY, 352, 65);
	ld	hl,#0x0041
	push	hl
	ld	hl,#0x0160
	push	hl
	...
	call	_SpriteManagerAdd
	add	sp, #5
;StateGame5.c:46: SpriteManagerAdd(SPRITE_ENEMY, 178, 65);
	ld	hl,#0x0041
	push	hl
	ld	l, #0xb2
	push	hl
	...
	call	_SpriteManagerAdd
	add	sp, #5
;StateGame5.c:47: SpriteManagerAdd(SPRITE_ENEMY2, 186, 170);
	ld	hl,#0x00aa
	push	hl
	ld	l, #0xba
	push	hl
	...
	call	_SpriteManagerAdd
	add	sp, #5
;StateGame5.c:49: InitScrollTiles(0, 59, tiles, 3);
	ld	hl,#0x0000
	push	hl
	ld	a,#0x03
	push	af
	...
	add	sp, #7
;StateGame5.c:50: InitScroll(map5Width, map5Height, map5, collilision_tiles5, 0, 3);
	ld	hl,#0x0000
	push	hl
	ld	a,#0x03
	push	af
...
;StateGame5.c:51: SHOW_BKG;
	...
	ld	(hl),c
	ret
;StateGame5.c:56: void Update_STATE_GAME5() {
;	---------------------------------
; Function Update_STATE_GAME5
; ---------------------------------
_Update_STATE_GAME5::
;StateGame5.c:57: if (KEY_PRESSED(J_START)) {
	ld	hl,#_keys
	ld	c,(hl)
	ld	b,#0x00
	bit	7, c
	ret	Z
;StateGame5.c:58: SetState(STATE_GAME6);
	ld	a,#0x06
	push	af
	inc	sp
	call	_SetState
